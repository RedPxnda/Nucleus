...
public class NullableCoolEntityFacet implements EntityFacet<CompoundTag> {
    public static FacetKey<NullableCoolEntityFacet> KEY; // We will use this later to retrieve our facet from entities. Define it here for now.
    ...
    public NullableCoolEntityFacet(Entity entity) {}
