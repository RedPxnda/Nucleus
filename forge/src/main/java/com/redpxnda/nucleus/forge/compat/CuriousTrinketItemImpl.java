package com.redpxnda.nucleus.forge.compat;
...
public class CuriousTrinketItemImpl extends CuriousTrinketItem implements ICurioItem {
    public final CuriousTrinketItem trinket;

    public CuriousTrinketItemImpl(CuriousTrinketItem trinket, Properties properties) {
        super(properties);
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        trinket.tick(stack, slotContext.entity());
    }

    @Override
    public void onEquip(SlotContext slotContext, ItemStack prevStack, ItemStack stack) {
        trinket.onEquip(stack, slotContext.entity());
    }

    @Override
    public void onUnequip(SlotContext slotContext, ItemStack newStack, ItemStack stack) {
        trinket.onUnequip(stack, slotContext.entity());
    }

    @Override
    public boolean canEquip(SlotContext slotContext, ItemStack stack) {
        return trinket.canEquip(stack, slotContext.entity());
    }

    @Override
    public boolean canUnequip(SlotContext slotContext, ItemStack stack) {
        return trinket.canUnequip(stack, slotContext.entity());
    }

    @Override
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        Multimap<Attribute, AttributeModifier> map = trinket.useNbtAttributeBehavior(stack, slotContext.entity(), uuid) ?
                ICurioItem.super.getAttributeModifiers(slotContext, uuid, stack) :
                HashMultimap.create();

        map.putAll(trinket.getAttributeModifiers(stack, slotContext.entity(), uuid));
        return map;
    }
